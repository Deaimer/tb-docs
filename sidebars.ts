...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {type: 'category', label: 'Getting started', collapsed: false, items: [
      ...
      'getting-started/official-sources',
    ...
    {type: 'category', label: 'Build the task', items: [
      ...
      'authoring/task-readme',
      'authoring/task-toml',
      'authoring/taxonomy',
      'authoring/environment',
      'authoring/multicontainer-gpu',
      'authoring/data-provenance',
      'authoring/solution',
      'authoring/verifier',
      'authoring/test-entrypoint',
    ]},
    ...
    {type: 'category', label: 'Reviewer desk', items: [
      ...
      'reviewing/implementation-rubric',
