...
For scientific or numerical tasks, compare the Oracle to an independent implementation, analytic special cases, conserved quantities, or published reference results. Independence matters: two scripts importing the same buggy function are not corroboration.
