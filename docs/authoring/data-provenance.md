...
<div className="source-line"><strong>Applies to:</strong> every data-backed Terminal-Bench task</div>
...
Any practice data must teach the contract without duplicating held-out answers. Splits should prevent entity, temporal, spatial, family, subject, or batch leakage as the domain demands. Random row splits are often invalid.

## Provenance manifest example

```json
{
  "source": "SOURCE_IDENTIFIER_AND_VERSION",
  "license": "CC-BY-4.0",
