...
- Correct schema, wrong domain or operational result.
...
Keep generators, expected verdicts, hidden fixtures, and threshold evidence reviewer-side and outside agent-visible paths.
