...
Typos in paths, missing dependencies, undocumented formats, impossible timeouts, flaky downloads, ambiguous units, hidden scientific assumptions, and arbitrary output formatting are defects.
...
| Selected invalid scientific method | domain reasoning difficulty |
