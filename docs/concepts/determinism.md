...
<div className="source-line"><strong>Applies to:</strong> environments, solutions, tests, and numerical computation</div>
...
## Choose tolerances from domain evidence
...
A tolerance wide enough to accept a materially wrong result is not robust. A tolerance narrower than ordinary numerical variation is not rigorous.
